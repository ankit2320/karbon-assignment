...
def total_revenue(data: dict, financial_index):
    ...
    try:
        ...
        net_revenue = financial_data["pnl"]["lineItems"]["netRevenue"]
        return net_revenue
...
def total_borrowing(data: dict, financial_index):
    ...
    try:
        financial_data = data["financials"][financial_index]
        long_term_borrowings = financial_data["bs"]["lineItems"]["longTermBorrowings"]
        short_term_borrowings = financial_data["bs"]["lineItems"]["shortTermBorrowings"]
...
def iscr(data: dict, financial_index):
    ...
    try:
        financial_data = data["financials"][financial_index]
        profit_before_interest_and_tax = financial_data["pnl"]["lineItems"]["profitBeforeInterestAndTax"]
        depreciation = financial_data["pnl"]["lineItems"]["depreciation"]
        interest_expenses = financial_data["pnl"]["lineItems"]["interestExpenses"]
